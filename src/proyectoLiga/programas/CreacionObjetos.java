...
public final class CreacionObjetos {
    ...
    public static List<Estadio> cargarEstadiosSerieA() {
        List<Estadio> lista = new ArrayList<>();

        try (BufferedReader br = new BufferedReader(new FileReader("src/proyectoLiga/data/serieA/ESTADIOS.txt"))) {
            String linea;
    ...
    public static List<Equipo> cargarEquiposSerieA(List<Estadio> estadios) {
        List<Equipo> lista = new ArrayList<>();

        Path ruta = Paths.get("src/proyectoLiga/data/serieA/EQUIPOS.txt");
    ...
    public static List<Entrenador> cargarEntrenadoresSerieA(List<Equipo> equipos) {
        List<Entrenador> lista = new ArrayList<>();

        try (BufferedReader br = new BufferedReader(new FileReader("src/proyectoLiga/data/serieA/ENTRENADORES.txt"))) {
            String linea;
    ...
    public static List<Jugador> cargarJugadoresSerieA(List<Equipo> equipos) {
        List<Jugador> listaJugadores = new ArrayList<>();

        Path ruta = Paths.get("src/proyectoLiga/data/serieA/JUGADORES.txt");
    ...
    public static List<Estadio> cargarEstadiosBundesliga() {
        List<Estadio> lista = new ArrayList<>();

        try (BufferedReader br = new BufferedReader(new FileReader("src/proyectoLiga/data/bundesliga/ESTADIOS.txt"))) {
            String linea;
    ...
    public static List<Equipo> cargarEquiposBundesliga(List<Estadio> estadios) {
        List<Equipo> lista = new ArrayList<>();

        Path ruta = Paths.get("src/proyectoLiga/data/bundesliga/EQUIPOS.txt");
    ...
    public static List<Entrenador> cargarEntrenadoresBundesliga(List<Equipo> equipos) {
        List<Entrenador> lista = new ArrayList<>();

        try (BufferedReader br = new BufferedReader(new FileReader("src/proyectoLiga/data/bundesliga/ENTRENADORES.txt"))) {
            String linea;
    ...
    public static List<Jugador> cargarJugadoresBundesliga(List<Equipo> equipos) {
        List<Jugador> listaJugadores = new ArrayList<>();

        Path ruta = Paths.get("src/proyectoLiga/data/bundesliga/JUGADORES.txt");
    ...
    public static List<Estadio> cargarEstadiosLigue1() {
        List<Estadio> lista = new ArrayList<>();

        try (BufferedReader br = new BufferedReader(new FileReader("src/proyectoLiga/data/ligue1/ESTADIOS.txt"))) {
            String linea;
    ...
    public static List<Equipo> cargarEquiposLigue1(List<Estadio> estadios) {
        List<Equipo> lista = new ArrayList<>();

        Path ruta = Paths.get("src/proyectoLiga/data/ligue1/EQUIPOS.txt");
    ...
    public static List<Entrenador> cargarEntrenadoresLigue1(List<Equipo> equipos) {
        List<Entrenador> lista = new ArrayList<>();

        try (BufferedReader br = new BufferedReader(new FileReader("src/proyectoLiga/data/ligue1/ENTRENADORES.txt"))) {
            String linea;
    ...
    public static List<Jugador> cargarJugadoresLigue1(List<Equipo> equipos) {
        List<Jugador> listaJugadores = new ArrayList<>();

        Path ruta = Paths.get("src/proyectoLiga/data/ligue1/JUGADORES.txt");
